...
namespace EHealthCardApp.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public PeopleController(EHealthCardContext context)
        {
            _context = context;
        }
        ...
        {
            var eHealthCardContext = _context.People.Include(p => p.ZipNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'EHealthCardContext.People'  is null.");
            }
            var person = await _context.People.FindAsync(id);
            if (person != null)
            {
